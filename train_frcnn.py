...
#     model_classifier.load_weights(C.base_net_weights, by_name = True)
    ...
    print('loading weights from {}'.format('model_frcnn.h5'))
    model_rpn.load_weights('model_frcnn.h5', by_name=True)
    model_classifier.load_weights('model_frcnn.h5', by_name = True)
except:
...
######################################## 4.6 ###########################################################################
            ...
            if iter_num == epoch_length:
                ...
                if curr_loss < best_loss:
                    ...
                    best_loss = curr_loss
                    model_all.save_weights("/home/zheyongsun/TF2.0_version/model_frcnn.h5")
