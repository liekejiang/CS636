...
#     model_classifier.load_weights(C.base_net_weights, by_name = True)
    ...
    model_rpn.load_weights('model_frcnn_cat.h5', by_name=True)
...
######################################## 4.6 ###########################################################################
            ...
            if iter_num == epoch_length:
                ...
                if curr_loss < best_loss:
                    ...
                    best_loss = curr_loss
                    model_all.save_weights("/home/zheyongsun/TF2.0_version/model_frcnn_cat.h5")
...
model_all.save_weights("/home/zheyongsun/TF2.0_version/finalmodel_frcnn_cat.h5")
